	...
	DatabaseConnection dbConnection;
			...
			public List<User> displayAllrecords()
			{
				...
				try {
					...
					while(rs.next())
					{
						User user=new User(rs.getString("username"),rs.getString("password"),rs.getString("fname"),rs.getString("address"),rs.getString("email"),rs.getString("phone"),rs.getString("lname"),rs.getString("sinNumber"),rs.getString("role"));
						list.add(user);
